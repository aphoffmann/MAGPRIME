...
def noiseMichibiki():
    ...
    qzs_1 = np.loadtxt(r"C:\Users\Alex\Documents\GitHub\MAGPRIME\magprime\utility\SPACE_DATA\michibiki.dat", dtype=float, usecols=(0,4,5,6,7,8,9))
    B_qzs = qzs_1.T
...
def run():
    ...
    if os.path.exists("kplo_results.csv"):
        # Read the existing CSV file and get the last seed value
        results = pd.read_csv("kplo_results.csv")
